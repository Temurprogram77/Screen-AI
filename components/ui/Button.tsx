...
const variantClasses: Record<NonNullable<ButtonProps["variant"]>, string> = {
  ...
  secondary:
    "bg-slate-700 text-white hover:bg-slate-600 focus-visible:ring-slate-500 disabled:bg-slate-500",
  ghost:
  ...
  outline:
    "border border-slate-300 dark:border-slate-600 bg-transparent text-slate-700 dark:text-slate-200 hover:bg-slate-50 dark:hover:bg-slate-800 focus-visible:ring-slate-400",
};
